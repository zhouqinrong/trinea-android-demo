...
public class BroadcastReceiverDemo extends Activity {
    ...
    private final static String                    ACTION_GENERAL_SEND = "com.trinea.android.demo.BroadcastReceiverDemo.sendGeneralBroadcast";
    private final static String                    ACTION_LOCAL_SEND   = "com.trinea.android.demo.BroadcastReceiverDemo.sendLocalBroadcast";
    private final static String                    ACTION_ORDERED_SEND = "com.trinea.android.demo.BroadcastReceiverDemo.sendOrderedBroadcast";
    private final static String                    ACTION_STICKY_SEND  = "com.trinea.android.demo.BroadcastReceiverDemo.sendStickyBroadcast";
